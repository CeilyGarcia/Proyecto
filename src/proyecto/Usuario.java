...
public class Usuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyecto/imagenes/bueno.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String Usuario = "ceily";
        String Contraseña = "12345";
       
        String Pase = new String(txtContraseña.getPassword());
        if (txtUsuario.getText().equals(Usuario) && Pase.equals(Contraseña))
        {
